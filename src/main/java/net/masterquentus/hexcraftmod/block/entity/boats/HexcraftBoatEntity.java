...
public class HexcraftBoatEntity extends Boat {
    ...
    public static enum Type implements StringRepresentable {
        ...
        public static final StringRepresentable.EnumCodec<HexcraftBoatEntity.Type> CODEC = StringRepresentable.fromEnum(HexcraftBoatEntity.Type::values);
    ...
    public static HexcraftBoatEntity.Type byId(int pId) {
