...
public class HexcraftBoatRenderer extends BoatRenderer {
    ...
    public HexcraftBoatRenderer(EntityRendererProvider.Context pContext, boolean pChestBoat) {
        ...
        this.boatResources = Stream.of(HexcraftBoatEntity.Type.values()).collect(ImmutableMap.toImmutableMap((type) -> type,
                (type) -> Pair.of(new ResourceLocation(HexcraftMod.MOD_ID, getTextureLocation(type, pChestBoat)), this.createBoatModel(pContext, type, pChestBoat))));
    }
    ...
    private ListModel<Boat> createBoatModel(EntityRendererProvider.Context pContext, HexcraftBoatEntity.Type pType, boolean pChestBoat) {
        ModelLayerLocation modellayerlocation = pChestBoat ? HexcraftBoatRenderer.createChestBoatModelName(pType) : HexcraftBoatRenderer.createBoatModelName(pType);
    ...
    public Pair<ResourceLocation, ListModel<Boat>> getModelWithLocation(Boat boat) {
        ...
        } else if(boat instanceof HexcraftBoatEntity modChestBoatEntity) {
