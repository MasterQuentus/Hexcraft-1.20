...
public class HexcraftItemTagGenerator extends ItemTagsProvider {
	...
	protected void addTags(HolderLookup.Provider provider) {
		...
		this.tag(ItemTags.TRIMMABLE_ARMOR)
				...
				.add(HexcraftItems.STEEL_LEGGING.get())
				.add(HexcraftItems.STEEL_BOOTS.get())
				.add(HexcraftItems.DARK_STEEL_HELMET.get())
				.add(HexcraftItems.DARK_STEEL_CHESTPLATE.get())
				.add(HexcraftItems.DARK_STEEL_LEGGING.get())
				.add(HexcraftItems.DARK_STEEL_BOOTS.get())
				.add(HexcraftItems.BLOODY_NYKIUM_HELMET.get())
				.add(HexcraftItems.BLOODY_NYKIUM_CHESTPLATE.get())
				.add(HexcraftItems.BLOODY_NYKIUM_LEGGING.get())
				.add(HexcraftItems.BLOODY_NYKIUM_BOOTS.get())
				.add(HexcraftItems.JORMIUM_HELMET.get())
				.add(HexcraftItems.JORMIUM_CHESTPLATE.get())
				.add(HexcraftItems.JORMIUM_LEGGING.get())
				.add(HexcraftItems.JORMIUM_BOOTS.get())
				.add(HexcraftItems.CUROGEN_HELMET.get())
				.add(HexcraftItems.CUROGEN_CHESTPLATE.get())
				.add(HexcraftItems.CUROGEN_LEGGING.get())
				.add(HexcraftItems.CUROGEN_BOOTS.get())
				.add(HexcraftItems.SILVER_HELMET.get())
				.add(HexcraftItems.SILVER_CHESTPLATE.get())
				.add(HexcraftItems.SILVER_LEGGING.get())
				.add(HexcraftItems.SILVER_BOOTS.get())
