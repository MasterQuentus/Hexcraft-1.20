...
import net.masterquentus.hexcraftmod.sound.HexcraftSoundEvents;
...
public class ChalkItem extends BlockItem {
    ...
    private void tryPlaceChalk(Level level, BlockPos pos, UseOnContext context) {
        ...
        level.playSound(context.getPlayer(), pos, HexcraftSoundEvents.CHALK_WRITE.get(), SoundSource.PLAYERS, 1F, 1F);
