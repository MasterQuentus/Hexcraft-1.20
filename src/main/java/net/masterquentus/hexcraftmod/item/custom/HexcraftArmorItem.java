...
import net.masterquentus.hexcraftmod.item.HexcraftArmorMaterials;
...
public class HexcraftArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(HexcraftArmorMaterials.BLOODYNYKIUM, new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 200, 1))
                    .put(HexcraftArmorMaterials.JORMIUM, new MobEffectInstance(MobEffects.WATER_BREATHING, 200, 1))
                    .put(HexcraftArmorMaterials.CUROGEN, new MobEffectInstance(MobEffects.ABSORPTION, 200, 1))
                    .build();

    public HexcraftArmorItem(ArmorMaterial material, Type type, Properties properties) {
