...
public class WitchesOvenRecipe extends AbstractCookingRecipe {
    public WitchesOvenRecipe(ResourceLocation pId, String pGroup, CookingBookCategory pCategory, Ingredient pIngredient, ItemStack pResult, float pExperience, int pCookingTime) {
    ...
    public static class Serializer implements RecipeSerializer<WitchesOvenRecipe> {
        ...
        public static final WitchesOvenRecipe.Serializer INSTANCE = new Serializer(50);
        ...
        public WitchesOvenRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new WitchesOvenRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public WitchesOvenRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
